<template>
    <div>
        <h2>{{$t('logs.title')}}</h2>
        <h3>
            <pre id="log-file" class="monospace m-right-sm">{{!view.follow ? 'tail -'+view.lines+' /var/log/sogo/sogo.log' : 'tail -f /var/log/sogo/sogo.log'}}</pre>
